    ...
    return (
        <div className="bg-black">
         <div className="mx-auto container pt-20">
            ...
            <div class="max-w-screen-xl p-10 pb-36  bg-black mx-auto px-4 sm:px-6 lg:px-8 relative py-26 lg:mt-20">
                <div class="relative">
                    <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
                        <div class="lg:col-start-2 lg:max-w-2xl ml-auto">
                            ...
                            <h4 class="mt-2 text-2xl leading-8 font-extrabold text-gray-200 dark:text-white sm:text-4xl sm:leading-9">
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Placeat, non.
                            </h4>
                            <p class="mt-4 text-lg leading-6 text-gray-200 dark:text-gray-300">
            ...
            <div class="p-4 pb-36">
                <p class="text-center text-5xl font-bold text-gray-200">
                    Professional team
                </p>
                <p class="text-center mb-32 text-xl font-normal text-gray-200">
                    Meat the best team in wolrd
                </p>
                <div class="flex items-center space-y-24 ms:space-y-0 flex-col md:flex-row justify-evenly">
                    <div class="p-4 relative">
                        <div class="text-center mb-4 absolute -top-16 right-1/2 transform translate-x-1/2">
                            <a href="#" class="block relative">
                                <img alt="profil" src="https://www.incimages.com/uploaded_files/image/1920x1080/getty_481292845_77896.jpg" class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800"/>
                            </a>
                        </div>
                    ...
                    <div class="p-4 relative">
                        <div class="text-center mb-4 absolute -top-16 right-1/2 transform translate-x-1/2">
                            <a href="#" class="block relative">
                                <img alt="profil" src="https://assets.entrepreneur.com/content/3x2/2000/20190502194704-ent19-june-editorsnote.jpeg" class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800"/>
                            </a>
                        </div>
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow px-8 py-4 pt-24">
                            <div class="text-center">
                    ...
                    <div class="p-4 relative">
                        <div class="text-center mb-4 absolute -top-16 right-1/2 transform translate-x-1/2">
                            <a href="#" class="block relative">
                                <img alt="profil" src="https://avada.theme-fusion.com/wp-content/uploads/2019/07/person_sample_2.jpg" class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800"/>
                            </a>
                        </div>
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow px-8 py-4 pt-24">
                            <div class="text-center">
